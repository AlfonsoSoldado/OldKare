# Generated by Django 2.0.3 on 2018-04-09 15:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offerer', models.ManyToManyField(blank=True, null=True, related_name='offerer', to=settings.AUTH_USER_MODEL, verbose_name='Solicitante')),
            ],
        ),
        migrations.CreateModel(
            name='UserDetails',
