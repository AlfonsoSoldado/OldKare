...
urlpatterns += i18n_patterns(
    ...
    path('feedback/add/<int:pk>', views.addFeedback, name='addFeedback'),
    ...
    path('terminos-y-condiciones', TemplateView.as_view(template_name="principal/terminosycondiciones.html")),
    path('terms-and-conditions', TemplateView.as_view(template_name="principal/termsAndConditions.html")),
